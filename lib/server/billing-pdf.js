    ...
    try {
      ...
      function drawFooter() {
        ...
        pdf.font('Helvetica-Bold').fontSize(8).fillColor(C.blue)
           ...
           .text('  ·  Moroni, Comores  ·  contact@info-experts.fr  ·  +269 331 27 22  ·  info-experts.fr');
      ...
      pdf.font('Helvetica').fontSize(8.5).fillColor(C.bluePale)
         .text('Moroni, Comores  ·  info-experts.fr  ·  +269 331 27 22', M, 50);
      ...
      const emLines = [
        ...
        { t:'+269 331 27 22',          f:'Helvetica',     fs:8.5 },
