  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.font('Helvetica').fontSize(9).fillColor(C.bluePale)
         .text('Moroni, Comores  ·  info-experts.fr  ·  +269 331 27 22', M, 56);
      ...
      ey += 13;
      doc.text('+269 331 27 22', M + 10, ey);
      ...
      doc.font('Helvetica-Bold').fontSize(9).fillColor(C.blue)
         ...
         .text(
           '  ·  Moroni, Comores  ·  contact@info-experts.fr  ·  +269 331 27 22  ·  info-experts.fr',
           { continued: false }
         );
